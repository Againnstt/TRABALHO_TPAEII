...
def carregar_dados():
    ...
    df["Política Institucional"] = df["Política Institucional"].replace({"Allowed_With_Citation":"Permitido com citação","Strict_Ban":"Proibição rigorosa","Actively_Encouraged":"Alto incentivo})
