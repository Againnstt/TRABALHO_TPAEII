...
def carregar_dados():
    ...
    df["Política Institucional"] = df["Política Institucional"].replace({"Actively_Encouraged":"Permitido com citação","Strict_Ban":"Proibição rigorosa","Actively_Encouraged":"Alto incentivo})
